#this progeam is design to compute the payroll salary of an employee

class Employee:
    hmdf = 100.00

    # initialization of constructor method of
    def __init__(self):
        #class Employee
        ...
        self. salary_cut_off = input("Enter Curt-Off Date:")

        #input for salary computation
        self.emp_rate_per_hour = float(input("Employee rate per hour:"))
        self.emp_number_of_hours_per_payday = int(input("Employee's number of hours worked per payday :"))
        self.emp_hour_overtime = float(input("Enter overtime hours: "))
        self.honorarium_pay = float(input("Enter honorarium pay: "))
        self.emp_num_of_absences = int(input("Enter absences: "))
        self.emp_num_tardiness = int(input("Enter tardiness: "))

    def emp_salary_computation(self):
        self.basic_pay = self.emp_rate_per_hour * self.emp_number_of_hours_per_payday
    ...
    def emp_sss_contribution(self):
        #Settin condition for Employee's Gross Earnings to get the SSS, Tax and PHILHealth Contribution
    ...
    def emp_philhealth_contribution(self):
        ...
        if self.emp_gross_earnings < 1000:
    ...
    def emp_tax_contribution(self):
        if self.emp_gross_earnings < 10417:
            ...
            self.tax_contribution = ((self.emp_gross_earnings - 16667) * 0.20 + 0.00)
            ...
            self.tax_contribution = ((self.emp_gross_earnings - 83333) * 0.30 + 0.1677 * 0.70)
        else:
    ...
    def emp_displayEmployee(self):
            ...
            print("Employee Name: ", self.company_name)
            print("Company Name: ", self.employee_name)
            print("Employee Code: ", self.employee_code)
            print("Cut_Off Date: ", self.salary_cut_off)
